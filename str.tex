...
SPSI serves as the theoretical foundation to build \specula, a transactional data store that incorporates an innovative set of speculative concurrency control techniques that allow to achieve up to XX$\times$ throught speed-ups and XX\% latency reduction with popular benchmarks like TPC-C and Rubis. Further, \specula integrates self-tuning mechanisms that
